    ...
    <form action="" method="post">
        <div class="text">
            <div class="translateInput">
                <p>入力スペース</p>
                <textarea name="fromText" rows="5" cols="50"  placeholder="翻訳するテキストを入力してください。"><?php echo $fromText;
                ?></textarea>
            </div>
            <p class="rightArrow">→</p>
            <div class="translateOutput">
                <p>翻訳結果</p>
                <textarea rows="5" cols="50" placeholder="翻訳後のテキストが表示されます。"><?php if($toText != ""){echo $toText;
                }?></textarea>
            </div>
        </div>
        <label>翻訳後言語</label>
