...
<nav class="MyInformationNav">
    <ul>
        <li><a href="http://keen-akune-3587.bambina.jp/charekyara/ANYPORT/mypage/mypage.php">登録情報</a></li>
...
foreach($result as $row) {
    ...
    echo '<h3><a href="okiniiriDetail.php?shop_id='.$row['shop_id'].'&favorite_id='.$row['favorite_id'].'"target="_blank" rel="noopener noreferrer">' .
        $row["shop_name"]
        . '</a></h3>';
