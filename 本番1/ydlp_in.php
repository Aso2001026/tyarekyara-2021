...
<article>
    <figure>
        <img src=".$record['Image']." alt='画像'>
    </figure>
    <div class='text_content'>
        <h3><a href='".$record['URL']."' target='_blank'>{$record["Name"]}</a></h3>
        <p class='text_excerpt'><br>場所  :{$record['Address']}</p>
    </div>
</article>
    ";
    }
